...
private extension WalletCoreAccount {
    ...
    var sendViewNavigationLink: some View {
    ...
    @ViewBuilder
    func makeWalletCoreAccountHeadlineView() -> some View {
        Text("Wallet Core")
    ...
    @ViewBuilder
    func makeOutputWalletCoreAccountView() -> some View {
    ...
    @ViewBuilder
    func makePasswordConfirmationView() -> some View {
    ...
    func makeDetailView() -> some View {
        VStack(spacing: 32) {
            makeWalletCoreAccountHeadlineView()
            
            makeOutputWalletCoreAccountView()
            
            sendViewNavigationLink
